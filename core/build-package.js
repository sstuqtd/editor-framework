...
exports.start = function ( opts, done ) {
    ...
    var gulp = new Gulp(); // create a gulp instance, must be done before any gulp module
    _logEvents(gulp);
    ...
    var useBabel = opts.babel || false;

    // ==============================
    // paths
    // ==============================

    var dest = Path.join(root, 'bin/dev');
    var ignores = [
        '!' + Path.join(root,'bin/**'),
    ...
    var allfiles = [Path.join('**/*')].concat(ignores);
