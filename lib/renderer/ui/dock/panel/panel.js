...
class DockPanel extends window.HTMLElement {
  static get tagName () { return 'EDITOR-DOCK-PANEL'; }
  ...
  createdCallback () {
    ...
    `;
    root.insertBefore(
      ResUtils.createStyleElement('editor-framework://lib/renderer/ui/css/panel.css'),
      root.firstChild
    );
...
_.assign(DockPanel.prototype, Resizable, Dockable);
