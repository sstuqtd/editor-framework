  ...
  template: `
    ...
    <div class="vbox">
      <div class="prop">
        ...
        <ui-slider id="r-slider" precision=3></ui-slider>
      </div>
      <div class="prop">
        <span class="green">G</span>
        <ui-slider id="g-slider" precision=3></ui-slider>
      </div>
      <div class="prop">
        <span class="blue">B</span>
        <ui-slider id="b-slider" precision=3></ui-slider>
      </div>
      <div class="prop">
        <span class="gray">A</span>
        <ui-slider id="a-slider" precision=3></ui-slider>
      </div>
      <div class="hex-field">
