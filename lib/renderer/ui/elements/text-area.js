...
module.exports = ElementUtils.registerElement('ui-text-area', {
  ...
  behaviors: [ Focusable, Readonly, InputState ],
  ...
  style: ResMgr.getResource('editor-framework://dist/css/elements/text-area.css'),
