...
Props.vec2 = {
  ...
  ready () {
    ...
    this._propX.addEventListener('slide', event => {
      this._inputX.value = this._inputX.value + event.detail.dx;
    });
    ...
    this._propY.addEventListener('slide', event => {
      this._inputY.value = this._inputY.value + event.detail.dx;
    });
...
Props.vec3 = {
  ...
  ready () {
    ...
    this._propZ.addEventListener('slide', event => {
      this._inputZ.value = this._inputZ.value + event.detail.dx;
    });
