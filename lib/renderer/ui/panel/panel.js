(() => {
  ...
  function _isPanel (el) {
    return el && el.tagName === 'EDITOR-PANEL';
  }
  ...
  Editor.JS.addon(Panel.prototype, EditorUI.Resizable, EditorUI.Dockable);

  EditorUI.isPanel = _isPanel;
  document.registerElement('editor-panel', Panel);
