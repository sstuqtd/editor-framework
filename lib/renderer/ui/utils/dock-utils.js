EditorUI.DockUtils = (function () {
    ...
    DockUtils.dragstart = function ( dataTransfer, tabEL ) {
        ...
        var panelEL = frameEL.parentNode;
        ...
        if ( frameEL ) {
            ...
            Editor.Panel.load( panelID, function ( err, frameEL ) {
                ...
                window.requestAnimationFrame ( function () {
                    var targetPanelEL = target.panelEL;
                    var newTabEL = document.createElement('editor-tab');
    ...
    document.addEventListener('drop', function ( event ) {
        ...
        if ( !frameEL ) {
            ...
            Editor.Panel.load( panelID, function ( err, frameEL ) {
                ...
                requestAnimationFrame ( function () {
                    var newPanel = document.createElement('editor-panel');
        ...
        var parentDock = panelEL.parentNode;
        ...
        if ( totallyRemoved ) {
            ...
            if ( newPanel.parentNode !== parentDock ) {
                ...
                var newParent = newPanel.parentNode;
