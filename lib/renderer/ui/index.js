...
UI.Prop.register('string', Props.string);
UI.Prop.register('number', Props.number);
UI.Prop.register('boolean', Props.boolean);
// UI.Prop.register('undefined', Props.undef);
// UI.Prop.register('array', Props.array);
UI.Prop.register('object', Props.object);
UI.Prop.register('enum', Props.enum);
UI.Prop.register('color', Props.color);
UI.Prop.register('vec2', Props.vec2);
UI.Prop.register('vec3', Props.vec3);
