...
Window.open = function ( name, url, options ) {
  Ipc.sendToMain( 'window:open', name, url, options );
};

Window.focus = function () {
  Ipc.sendToMain( 'window:focus' );
};

Window.load = function ( url, argv ) {
  Ipc.sendToMain( 'window:load', url, argv );
};

Window.resize = function ( w, h, useContentSize ) {
  Ipc.sendToMain( 'window:resize', w, h, useContentSize );
};
