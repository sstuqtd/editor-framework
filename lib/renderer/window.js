...
Window.open = function ( name, url, options ) {
  Ipc.sendToCore( 'window:open', name, url, options );
}

Window.focus = function () {
  Ipc.sendToCore( 'window:focus' );
}

Window.load = function ( url, argv ) {
  Ipc.sendToCore( 'window:load', url, argv );
}

Window.resize = function ( w, h, useContentSize ) {
  Ipc.sendToCore( 'window:resize', w, h, useContentSize );
}
