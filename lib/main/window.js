...
class Window extends EventEmitter {
  constructor ( name, options ) {
    ...
    // TODO: add option.doNotRedirect to prevent click <a> and redirect
    ...
    //   }
    // }
    // this.nativeWin.webContents.on('will-navigate', handleRedirect)
    // this.nativeWin.webContents.on('new-window', handleRedirect)
  ...
  _sendToPanel ( panelID, message, ...args ) {
    if ( typeof message !== 'string' ) {
      Console.error(`The message ${message} sent to panel ${panelId} must be string`);
      return;
    }
