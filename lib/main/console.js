...
Console.log = function (...args) {
  ...
  Winston.normal(text);
  Ipc.sendToWins('console:log',text);
};
...
Console.success = function (...args) {
  ...
  Ipc.sendToWins('console:success',text);
};
...
Console.failed = function (...args) {
  ...
  Winston.failed(text);
  Ipc.sendToWins('console:failed',text);
};
...
Console.info = function (...args) {
  ...
  Winston.info(text);
  Ipc.sendToWins('console:info',text);
};
...
Console.warn = function (...args) {
  ...
  Winston.warn(text);
  Ipc.sendToWins('console:warn',text);
};
...
Console.error = function (...args) {
  ...
  Winston.error(text);
  Ipc.sendToWins('console:error',text);
};
...
ipcMain.on('console:query', ( event ) => {
  event.reply(_logs);
});
