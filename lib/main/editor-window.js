...
class EditorWindow extends EventEmitter {
   ...
   * @method find
   * @static
   * @param {string|BrowserWindow|WebContents} param
  ...
  static find ( param ) {
    ...
    // NOTE: the BrowserWindow.webContents is an EventEmitter
    if ( param instanceof EventEmitter ) {
      param = BrowserWindow.fromWebContents(param);
    }
