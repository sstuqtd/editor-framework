...
let TestHelper = {
  ...
  click ( target, x, y, button, modifiers ) {
    ...
    this.mousedown(target, pos.x, pos.y);
    this.mouseup(target, pos.x, pos.y);
    target.dispatchEvent(_mouseEventFor('click', pos.x, pos.y, button ));

    // DISABLE
    // this.mousedown(target, pos.x, pos.y, button, modifiers);
    // this.mouseup(target, pos.x, pos.y, button, modifiers);
  },
  ...
  dblclick ( target, x, y, button, modifiers ) {
    ...
    // DISABLE
    // this.mousedown(target, pos.x, pos.y, button, modifiers, 2);
    // this.mouseup(target, pos.x, pos.y, button, modifiers, 2);
  },
  ...
  mousetrack ( target, from, to, steps ) {
    this.mousedown(target, from.x, from.y, 'left');
    this.mousemove(target, from, to, steps, 'left');
    this.mouseup(target, to.x, to.y, 'left');
  },
